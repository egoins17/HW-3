...
* Any comments you have: I am not sure if I have appropriately applied the model to the training data!
...
ANSWER : The model performed slightly better on the "training" data (63.88%) than on the "test" data (54.97%). This is most likely because the model was originally traininged on the "training" data, and therefore it should produce more accurate statistics when it is run on that data set.
...
ANSWER : In order to make this comparison, I took a subset of the graph for the gold data to match the dates of the bitcoin data. It is easy to see that gold is more volatile than bitcoin on a day-to-day basis. I would advise the exchanger to use bitcoin instead of gold for trading because you can better predict its future value. 
